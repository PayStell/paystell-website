  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Review the payment details and connect your wallet to proceed.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          {paymentState === "COMPLETED" ? (
            ...
            <Card>
              <CardContent className="pt-6">
                <Button onClick={processPayment} disabled={!canProceed || isProcessing} className="w-full" size="lg">
                  {isProcessing ? (
                    <>
                ...
                {error && error.recoverable && paymentState === "FAILED" && (
                  <Button variant="outline" onClick={processPayment} className="w-full mt-2 bg-transparent">
                    Try Again
                  </Button>
                )}
              </CardContent>
