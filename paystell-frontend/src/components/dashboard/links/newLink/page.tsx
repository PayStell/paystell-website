        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-96 p-6 rounded-lg shadow-lg">
            <button
              ...
              className="relative top-0 right-6 text-white p-2 text-2xl rounded-lg border bg-[#009EFF] hover:text-gray-800"
            >
              ✖
            </button>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-96 p-6 rounded-lg shadow-lg">
            <button
              ...
              className="relative top-0 right-6 text-white p-2 text-2xl rounded-lg border bg-blue-500 hover:text-gray-800"
            >
              ✖
            </button>
            <h2 className="text-center text-xl font-bold mb-4">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-full px-3 py-2 border bg-gray-100 rounded-lg"
                />
                <button className="px-4 py-2 bg-[#009EFF] text-white rounded-lg hover:bg-blue-600">
                  Copy
                </button>
              </div>
            </div>
