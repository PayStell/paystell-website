    ...
    <div className="container mx-auto px-4 py-6">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-start md:space-x-4">
          <Button type="button" size="lg" className="bg-blue-600 text-white w-full md:w-auto">
            <FaFacebook className="w-5 h-5" />
            <span>Facebook</span>
          </Button>

          <Button type="button" size="lg" className="bg-black text-white w-full md:w-auto">
            <FontAwesomeIcon icon={faXTwitter} className="w-5 h-5" />
            <span>Twitter</span>
          </Button>

          <Button type="button" size="lg" className="bg-green-500 text-white w-full md:w-auto">
            <FaWhatsapp className="w-5 h-5" />
            <span>WhatsApp</span>
          </Button>

          <Button type="button" size="lg" className="bg-blue-700 text-white w-full md:w-auto">
