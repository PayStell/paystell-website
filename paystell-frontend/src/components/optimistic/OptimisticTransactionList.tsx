      ...
      <CardContent>
        {getTotalCount() === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-sm">Transactions will appear here when you make deposits or withdrawals</p>
          </div>
        ) : (
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          {transaction.transactionHash && (
                            <DropdownMenuItem onClick={() => handleViewOnExplorer(transaction.transactionHash!)}>
            ...
            {queue[selectedTab].some(tx => tx.error) && (
              <div className="space-y-2">
                ...
                {queue[selectedTab]
                  .filter(tx => tx.error)
                  .map((transaction) => (
                    <div key={transaction.id} className="p-2 bg-red-50 border border-red-200 rounded text-sm">
