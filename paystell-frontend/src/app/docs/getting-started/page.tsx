  ...
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <p className="text-lg text-gray-300 mb-6">
        Welcome to the PayStell API documentation. This guide will help you get started with
        integrating our payment processing services into your application.
      </p>

      <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Base URL</h2>
      <p className="text-gray-300 mb-4">All API requests should be made to our base URL:</p>
      <CodeExample code="https://api.paystell.com" language="text" />

      <h2 className="text-2xl font-semibold text-white mt-8 mb-4">Authentication</h2>
      <p className="text-gray-300 mb-4">
        To authenticate your requests, you&apos;ll need to include your API key in the request
        headers:
      </p>
      <CodeExample code={`X-API-Key: your_api_key_here`} language="text" />
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-300">
        <li>
          <code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">GET</code> - Retrieve
          data
        </li>
        <li>
          <code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">POST</code> - Create new
          resources
        </li>
        <li>
          <code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">PUT</code> - Update
          existing resources
        </li>
        <li>
          <code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">DELETE</code> - Remove
          resources
        </li>
      </ul>
...
Response:
{
  ...
  "data": {
    ...
    "currency": "USD"
      ...
      <p className="text-gray-300 mb-4">All API responses follow a consistent format:</p>
      <CodeExample
        code={`{
  "success": true,
  "data": {
  ...
  "error": "Error message"
      ...
      <p className="text-gray-300 mb-4">
        Now that you understand the basics, you can explore our API reference documentation for
        detailed information about specific endpoints and features.
      </p>
    </div>
  );
}
