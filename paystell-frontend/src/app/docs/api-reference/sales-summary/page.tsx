  ...
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <p className="text-gray-300 mb-4">
        Retrieves a comprehensive summary of sales data.
      </p>
      <CodeExample
...
Response (200 OK):
{
  ...
  "data": {
    ...
    "topProducts": [
      ...
      <p className="text-gray-300 mb-4">
        Retrieves the total sales amount for a specific period.
      </p>
      <CodeExample
...
Response (200 OK):
{
  ...
  "data": {
    ...
    "period": {
      ...
      <p className="text-gray-300 mb-4">
        Retrieves sales data broken down by time periods.
      </p>
      <CodeExample
...
Response (200 OK):
{
  ...
  "data": {
    "products": [
      ...
      <p className="text-gray-300 mb-4">
        Common error responses for sales summary endpoints:
      </p>
      <CodeExample
        code={`{
  "success": false,
...

{
  ...
  "error": "Unauthorized"
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-300">
        <li><code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">400</code> - Bad Request (Invalid parameters)</li>
        <li><code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">401</code> - Unauthorized (Invalid API key)</li>
        <li><code className="bg-gray-800 px-2 py-1 rounded text-sm font-mono">404</code> - Not Found (Invalid endpoint)</li>
